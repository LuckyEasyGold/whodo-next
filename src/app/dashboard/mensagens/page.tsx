...
export default function MensagensPage() {
    ...
    return (
        <div className="flex overflow-hidden bg-slate-50 -m-4 sm:-m-6 lg:-m-8 h-[calc(100dvh-9.5rem)] md:h-[calc(100vh-4rem)]">
            ...
            {/* Área do chat */}
            <div className={`flex-col min-w-0 ${!conversaAtiva ? 'hidden md:flex flex-1' : 'flex fixed left-0 right-0 top-16 bottom-16 z-[60] bg-slate-50 md:relative md:z-auto md:flex-1 md:top-0 md:bottom-0'}`}>
                {!conversaAtiva ? (
