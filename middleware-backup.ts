...
export function middleware(request: NextRequest) {
    ...
    const hasSession = request.cookies.has("whodo_session") || request.cookies.has("__Secure-next-auth.session-token");
...
export const config = {
    // Aplica o middleware em todas as rotas, exceto arquivos estáticos e API interna do Next
